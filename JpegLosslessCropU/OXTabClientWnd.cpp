...
//////////////////////////////////////////////////////////////////////////////
void COXTabWorkspace::OnTimer(UINT_PTR nIDEvent) 
{
								 ...
								 BOOL bOnlyVisible/*=TRUE*/)
{
	...
	HICON hIcon=(HICON)::GetClassLong(pChildWnd->m_hWnd,GCLP_HICONSM);
	if(hIcon==NULL)
	{
		...
		if(hIcon==NULL)
		{
			hIcon=(HICON)::GetClassLong(pChildWnd->m_hWnd,GCLP_HICON);
			if(hIcon==NULL)
