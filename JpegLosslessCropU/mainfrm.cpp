...
// Get the active view attached to the active MDI child window.
	...
	if (pView == NULL)
		...
		{
		case  1:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("1/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("12.5 %"));
			break;
		case  2:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("2/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("25 %"));
			break;
		case  3:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("3/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("37.5 %"));
			break;
		case  4:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("4/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("50 %"));
			break;
		case  5:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("5/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("62.5 %"));
			break;
		case  6:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("6/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("75 %"));
			break;
		case  7:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("7/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("87.5 %"));
			break;
		case  8:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("8/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("100 %"));
			break;
		case  9:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("9/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("112.5 %"));
			break;
		case 10:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("10/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("125 %"));
			break;
		case 11:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("11/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("137.5 %"));
			break;
		case 12:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("12/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("150 %"));
			break;
		case 13:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("13/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("162.5 %"));
			break;
		case 14:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("14/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("175 %"));
			break;
		case 15:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("15/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("187.5 %"));
			break;
		case 16:
			((CMainFrame *)pFrame)->m_scale.SetWindowText(_T("16/8"));
			((CMainFrame *)pFrame)->m_zoom.SetWindowText(_T("200 %"));
			break;
		}
	else
		switch (((CSliderCtrl *) pScrollBar)->GetPos())
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
    ...
    if (!m_scale.Create(_T("8/8"), SS_CENTERIMAGE | SS_RIGHT | WS_VISIBLE | WS_TABSTOP,
	...
	int i;
    for ( i = 0; i < 14; i++) m_slider.tic[i+1] = m_slider.GetTicPos(i);
    ...
    if (!m_zoom.Create(_T("100 %"), SS_CENTERIMAGE | WS_VISIBLE | WS_TABSTOP,
